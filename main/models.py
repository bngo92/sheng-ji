...
class Game(models.Model):
    ...
    def get_trump_rank_display(self): return dict(RANK_CHOICES)[int(self.trump_rank)]
    trump_suit = models.CharField(max_length=1, choices=SUIT_CHOICES, default=RED)
    def get_trump_suit_display(self): return dict(SUIT_CHOICES)[int(self.trump_suit)]
